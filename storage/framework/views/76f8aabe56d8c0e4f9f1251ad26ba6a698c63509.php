            ...
            <div class="logo-box">
                <div class="logo">
                    <a href="<?php echo e(home_url()); ?>">
						...
						<img src="<?php echo e(asset('/images/eustlogo.svg')); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
                        <?php else: ?>
                            <img src="<?php echo e(asset('/images/eustlogo.svg')); ?>" alt="logo">
                        <?php endif; ?>
                    </a>
                </div>
            </div>
...
<?php /**PATH /var/www/vhosts/eustach.fr/2465521004237726.eustach.fr/modules/Layout/parts/header.blade.php ENDPATH**/ ?>